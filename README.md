...
Distracted driver classification is difficult when only ~50 subjects is provided in the training data set (disregard the total number of training images for now). Skin tone, hair colour/style and clothing colour/style are hugely variable amongst the test subjects, whilst the variation between posture-detection categories (within-subject) is quite small. I had difficulty visually distinguishing the category of some of the radio tuning vs and grooming classifications; radio tuning vs reaching behind vs talking to passenger; good driving (when looking to right, presumably at an intersection) vs talking to passenger; and good driving (when looking at rear view mirror) vs makeup.

By way of personal introduction, I am a chemical engineer who became interested in manufacturing process optimisation and gained a Master of Science Phil. (Statistics) degree. In preparation for that research I completed coursework in Advanced Multivariate Statistics, Mathematical Statistics, and Data Mining/Machine Learning and completed a thesis in the domain of Quality/Industrial/Process Engineering. The purpose of this repository is to demonstrate my practical skills in Deep Learning using Python | Numpy | Pandas | Keras | Theano. 
